...
def load_llm():
    ...
    llm = CTransformers(
        model = "/Users/kalpa/OneDrive/Desktop/Mottiv/Question_AnswerApp/Question-Answer-Generation-App-using-Mistral-7B/mistral-7b-instruct-v0.1.Q4_K_S.gguf",
...
def llm_pipeline(file_path):
    ...
    Your goal is to prepare a list of questions.
